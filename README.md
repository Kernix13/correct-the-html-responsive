...
- [x] - **_BONUS_** \* Update `stories\ai-takes-over.html` to include the updates from `index.html`

> If your only goal is to make some changes in your fork and push them to GitHub → you don’t need the upstream remote yet. Just do:
